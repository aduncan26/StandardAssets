Shader "GrimTrigger/WireframeCrosshatch 1" {

	Properties {
//		_Thickness ("Thickness", Float) = 1
		_Color ("Color", Color) = (1,1,1,1)
		_LineColor ("Line Color", Color) = (1,1,1,1)
//		_DisintegrationX ("Disintegration X", Range(0,10)) = 0
//		_DisintegrationY ("Disintegration Y", Range(0,10)) = 0
//		_DisintegrationZ ("Disintegration Z", Range(0,10)) = 0
...
//			#include "AutoLight.cginc"
			...
			uniform float _DisintegrationX;
			uniform float _DisintegrationY;
			uniform float _DisintegrationZ;
			...
			void geom(triangle v2g p[3], inout TriangleStream<g2f> triStream)
			{
				...
				//Multiply by 1 or 0 to make invisible
				float oppositeDist0 = _DisintegrationX;// p[0].tangent.x * dist0;
				float oppositeDist1 = _DisintegrationY;//p[1].tangent.x * dist1;
				float oppositeDist2 = _DisintegrationZ;//p[2].tangent.x * dist2;
				...
				pIn.dist = float3(dist0,oppositeDist1,oppositeDist2);
				...
				pIn.dist = float3(oppositeDist0,dist1,oppositeDist2);
				triStream.Append(pIn);
				...
				pIn.dist = float3(oppositeDist0,oppositeDist1,dist2);
				triStream.Append(pIn);
